        ...
        <div class="col-lg-6 mb-5 mb-lg-0 position-center">
            <div class="card bg-glass">
                <div class="card-body px-5 py-5 px-md-5">
                    <div class="logo">
                        <img style="width: 50%; height: 50%; border-radius: 129.50px; border: 2px #74583E solid" src="{{asset('images\logoLogin.jpg')}}" alt="logo login" />
                    </div>
                    <form class="form" style="margin-top: 35px;" action="{{ url('gyms') }}">
                        @csrf
                        <div class="mb-3">
