    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-12 text-center">
                <button type="submit" style="color: white; font-size: 30px; background-color: green; border-radius: 8px;" class="btn formed btn-block mb-4 mt-4">
                    <a href="{{('tambahPegawai')}}" style="text-decoration: none; color: inherit;">
        ...
        <div class="row g-4">
            ...
            <div class="col-6 col-md-4 col-lg-3">
                <div class="card">
                    <img class="card-img-top gambar" style="margin:auto;" src="{{$item['gambar']}}">
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-center">
                            <button type="submit" style="border-radius: 8px; background-color: green; margin-right: 10px" class="btn btn-primary btn-block mb-1 mt-1">
                                <a class="nav-link" href="#">Call</a>
                            </button>
                            <button type="submit" style="border-radius: 8px;" class="btn btn-primary btn-block mb-1 mt-1 btn-danger">
