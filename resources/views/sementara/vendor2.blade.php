...
<body class="antialiased">
    ...
    <header>
        <nav class="navbar navbar-dark bg-dark">
            <div class="container-fluid">
                ...
                <h1 style="color:white;"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-3">
                <div class="card mb-3">
                    <img class="card-img-top gambar" style="margin-right:auto; margin-left:auto; margin-top:auto;" src="{{$item['gambar']}}">
                    <div class="card-body" style="margin:auto;">
                        <div>
                            <p style="text-align:center;"><strong style="margin:auto;">{{ $item['nama'] }}</strong></p>
                        </div>
                        <div>
