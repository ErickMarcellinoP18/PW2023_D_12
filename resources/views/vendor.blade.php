...
<body>
    <header>
        <nav class="navbar navbar-dark bg-dark">
            <div class="container-fluid">
                ...
                <h1 style="color: white; margin-left: -40px; margin-top: 10px">Daftar Vendor</h1>
                    ...
                    <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{('vendor')}}">
                                ...
                                </svg> <strong>Daftar Vendor</strong>
                            </a>
                        </li>
                        <li class="nav-item">
    ...
    <div class="container">
        <div class="btn-container">
            <a href="{{('tambahVendor')}}" class="add-vendor-btn btn btn-block btn-success">
