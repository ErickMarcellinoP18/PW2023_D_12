...
<body class="antialiased">
    <div class="col-3" style="margin:auto; margin-top:60px;">
        <div class="card" style="background-color: #74583E; color:white;">
            <img style="margin:auto; padding:5px; height: 300px; width:300px; border-radius:100%" src="{{$dude['gambar']}}">
            <div class="card-body">
                <table>
                    <tr>
                        <th colspan="2" style="text-align: center;">Profile Admin {{ $dude['nickname'] }}</th>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
                    </tr>
